...
const siteConfig = {
  username: "seoyunje", // GitHub 사용자 이름
  repositoryName: "develop_blog", // GitHub 저장소 이름
  mainColor: "#1D63ED", // Docker Offical Blue
  textColor: "#172B4D", // Deep Navy
  blogTitle: "나만의 개발 블로그", // 블로그 제목
};
...
const users = [
  {
    ...
    company: "Link",
    position: "CEO",
    img: "img/user/profile-peter.jpg",
  },
];
